          ...
          builder: (context, state){
            if(state is WeatherIsNotSearched)
              return Container(
                ...
                child: Column(
                  children: <Widget>[
                    Text("Search ", style: TextStyle(fontSize: 40, fontWeight: FontWeight.w500, color: Colors.white70),),
                    Text("Current Weather", style: TextStyle(fontSize: 40, fontWeight: FontWeight.w200, color: Colors.white70),),
                    SizedBox(height: 24,),
                    TextFormField(
